...
const ActionBar = () => {
  const { isRetweetedByCurrentUser, handleToggleLike, handleToggleRetweet } = React.useContext(TweetContext);
  return (
    <Wrapper>
      ...
      <Action color="rgb(23, 191, 99)" size={40} onClick={handleToggleRetweet}>
        {isRetweetedByCurrentUser  && <PoppingCircle size={`40px`} color="rgb(23, 191, 99)" />}
